...
// Fetch only pending service reports
$sql = "SELECT ar.report_id,
        ...
        JOIN users u ON ar.reporter_id = u.user_id
        WHERE ar.report_type = 'r_service'
      ...
      <table>
        ...
        <tbody>
          <?php foreach ($reports as $r): ?>
            <tr>
              <td data-label="Report ID"><?= htmlspecialchars($r['report_id']) ?></td>
              <td data-label="Service"><?= htmlspecialchars($r['service_name'], ENT_QUOTES) ?></td>
          ...
          <?php if (empty($reports)): ?>
            <tr>
              <td colspan="7" style="text-align:center; padding:20px;">No pending reports.</td>
            </tr>
          <?php endif; ?>
        </tbody>
      </table>
