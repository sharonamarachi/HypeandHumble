...
// Get the conversation id from GET parameters.
if (!isset($_GET['chat_id'])) {
    die("No conversation specified.");
}
$chat_id = (int) $_GET['chat_id'];

// (Optional) You might want to verify that the user is a participant in this conversation here.
// ...

// For convenience, you can also retrieve the conversation subject or contact info from the database.
// Here, we'll assume the conversation subject is passed or set as a placeholder.
